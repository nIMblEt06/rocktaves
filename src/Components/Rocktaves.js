...
export default function Rocktaves() {
    ...
    return (
        <Box w="90%" marginInline="auto" mt="4rem" color="#B9B9B9" pb="2rem" position="relative">
            ...
            <Flex className='twoItems' justifyContent="space-between">
                <Box className='text' fontSize="1.6rem" w="80%" pt="3rem" paddingRight="6rem" pl="4rem" borderRight={"6px solid #E042FE"} lineHeight="3.8rem">
            ...
            <Text className='subHead' fontSize="1.6rem" ml="4rem" color="#E042FE" mt="4rem" >RULES:</Text>
            <VStack>
            <Box fontSize="1.6rem" w="80%" pt="2rem" className='ruleText' >
