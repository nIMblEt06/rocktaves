...
export default function Rocktaves() {
    ...
    return (
        <Box w="90%" marginInline="auto" mt="4rem" color="#B9B9B9" pb="2rem" position="relative">
            <Image className="bgFloat" right="-3rem" bottom="-10rem" w="25rem" src = "../Images/triangle.png"/>
            ...
            <Flex justifyContent="space-between">
                ...
                <Box className="parallax" mt="-8rem" ml="4rem" mr="-16rem">
                    <Image src="./Images/flameGuitar.png" w="70%"  />
                </Box>
            </Flex>
