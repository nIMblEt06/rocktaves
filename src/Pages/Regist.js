...
export default function Regist() {
    ...
    return (
        <Box bg="url(../Images/registBg.jpg)" bgPosition="center" bgSize="cover" bgColor="#0a0909" h="100vh" w="100vw">
            <Cursor/>
            <Flex marginInline="6rem" justifyContent="space-between" alignItems="center">
                <Box _hover={{ 'bgColor': '#E001FE' }} transition="0.3s all" cursor="pointer" onClick={clickBack} transform="translateY(10px)" p="0.6rem 1rem" color="#B9B9B9" bgColor="#E042FE"><ArrowBackIcon w="1.6rem" h="1.6rem" /></Box>
                <Heading pt="2rem" textAlign="center" fontSize="5rem" letterSpacing="0.2rem" color="#E042FE">RegistratioN</Heading>
                <Text></Text>
            </Flex>
            <Flex fontFamily="Hermona" color="#B9B9B9" w="90vw" marginInline="auto" justifyContent="space-around">
                <Box fontSize="3rem" color="#E042FE" display="inline">Band <Text display="inline" color="#B9B9B9"  >Info</Text></Box>
                <Box fontSize="3rem" color="#E042FE" display="inline">Contact <Text display="inline" color="#B9B9B9" >Info</Text></Box>
            </Flex>
            <Flex>
                <VStack ml="12rem" color="#B9B9B9" borderRight="3px solid #E042FE" w="40%" >
                    <FormControl>
                ...
                <VStack ml="8rem" color="#B9B9B9" w="40%">
                    <FormControl>
                        <Text fontSize="1.2rem" ml="-3rem" color="#E042FE">CONTACT 1:</Text>
                        ...
                        <Text mt="2rem" fontSize="1.2rem" ml="-3rem" color="#E042FE">CONTACT 2:</Text>
                        ...
                        <Text mt="2rem" fontSize="1.2rem" ml="-3rem" color="#E042FE">CONTACT 3 (IF ANY):</Text>
            ...
            <Flex justifyContent="center" mt="2rem" w="100vw"><Button onClick={handleSubmit} _hover={{ 'bgColor': '#99361F' }} fontFamily="Hermona" color="white" bgColor="#E042FE" padding="2.2rem 3.6rem" fontSize="3rem" fontWeight="400" borderRadius={0}>REGISTER</Button></Flex>
        </Box >
    )
}